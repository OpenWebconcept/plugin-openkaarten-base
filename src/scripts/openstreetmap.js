...
const { mapLocations, minLat, maxLat, minLong, maxLong, centerLat, centerLong } = window.leaflet_vars;
const locationItems = JSON.parse(mapLocations);
